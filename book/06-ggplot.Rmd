...
Make sure to use the tips and links at the end of this chapter, when you are done save the file using the commands below and submit to Blackboard
...
Remember to Download your image file from RStudio Cloud onto YOUR computer so that it is available for upload to Blackboard.
```
