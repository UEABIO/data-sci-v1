library(knitr)
## set knitr options
opts_chunk$set(cache = TRUE, tidy = F, fig.align = "center", fig.width = 5, fig.height = 5, multCode = F, titles = c("Base R", ifelse(opts_knit$get("rmarkdown.pandoc.to") != "latex", "<tt>tidyverse</tt>", "\\texttt{tidyverse}")))
