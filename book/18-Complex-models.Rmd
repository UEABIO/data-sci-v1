...
```{task}
Is there an obvious difference in the longevities of males across the three treatments?
```
...
```{task}
Does it look like size affects longevity?
```
...
```{task}
Does it look like size interacts with treatment to affect longevity?
```
...
```{task}
Does it look like sleep interacts with treatment to affect longevity?
```
