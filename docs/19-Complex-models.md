...
<img src="19-Complex-models_files/figure-html/unnamed-chunk-7-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="19-Complex-models_files/figure-html/unnamed-chunk-42-1.png" alt="A density distribution of longevity across the three sexual activity treatments" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="19-Complex-models_files/figure-html/unnamed-chunk-43-1.png" alt="A scatterplot of longevity against body size (thorax (mm)). No trend line added - often it is a good idea to look at data points without being lead to a conclusion by a line" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="19-Complex-models_files/figure-html/unnamed-chunk-44-1.png" alt="A scatterplot of thorax against longevity - colours indicate treatment types. This time I have included a line, as it will help determine if I think the slopes are different by group" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="19-Complex-models_files/figure-html/unnamed-chunk-45-1.png" alt="A scatter plot of proportion of time spent sleeping against longevity with a linear model trendline. Points represent individual flies, colours represent treatments." width="100%" />
...
<img src="19-Complex-models_files/figure-html/unnamed-chunk-21-1.png" width="100%" style="display: block; margin: auto;" />
...
<div class="figure" style="text-align: center">
<img src="19-Complex-models_files/figure-html/unnamed-chunk-27-1.png" alt="standard curve fitted by maximum likelihood, dashed lines represent the 95% confidence interval range for picking the 'best' transformation for the dependent variable" width="100%" />
...
<img src="19-Complex-models_files/figure-html/unnamed-chunk-49-1.png" width="100%" style="display: block; margin: auto;" />
...
```{=html}
<div id="youlnzvjce" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#youlnzvjce .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#youlnzvjce .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#youlnzvjce .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#youlnzvjce .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#youlnzvjce .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#youlnzvjce .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#youlnzvjce .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#youlnzvjce .gt_from_md > :first-child {
  margin-top: 0;
}

#youlnzvjce .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#youlnzvjce .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#youlnzvjce .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#youlnzvjce .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#youlnzvjce .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#youlnzvjce .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#youlnzvjce .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#youlnzvjce .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#youlnzvjce .gt_font_normal {
  font-weight: normal;
}

#youlnzvjce .gt_font_bold {
  font-weight: bold;
}

#youlnzvjce .gt_font_italic {
  font-style: italic;
}
