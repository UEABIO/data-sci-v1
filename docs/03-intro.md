...
<caption style="font-size: initial !important;">(\#tab:unnamed-chunk-8)dplyr verbs</caption>
 <thead>
  <tr>
...
<table class="table" style="font-size: 16px; width: auto !important; margin-left: auto; margin-right: auto;">
<caption style="font-size: initial !important;">(\#tab:unnamed-chunk-13)Boolean expressions</caption>
 <thead>
  <tr>
