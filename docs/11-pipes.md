...
Where do pipes send the result of the function that precedes the pipe? <select class='webex-select'><option value='blank'></option><option value=''>To the last argument of the next function.</option><option value='answer'>To the first argument of the next function.</option><option value=''>To the third argument of the 18th function.</option></select>
